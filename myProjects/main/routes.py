...
def home():
    ...
    return render_template('home.html', title = 'Home', page_details = "My Projects", posts = posts, page = page, **leetcode)
...
def about():  
    ...
    with open(os.path.join(current_app.root_path + '/static/leetcode.json'), 'r') as json_file:
        leetcode = json.load(json_file)
    return render_template('about.html', title = 'About', page_details = "About Me", **leetcode)
...
def test(): 
    ...
    with open(os.path.join(current_app.root_path + '/static/leetcode.json'), 'r') as json_file:
        leetcode = json.load(json_file)
    print(leetcode)
    return render_template('about.html', title = "Test", page_details = 'Test TEST', **leetcode)
